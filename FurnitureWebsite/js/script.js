    ...
    document.addEventListener('click', (event) => {
        ...
        switch (action) {
            ...
            case 'checkout':
                ...
                break;
            case 'close-cart':
                if (target.id === 'cartOverlay') toggleCart();
                break;
            case 'close-wishlist':
                if (target.id === 'wishlistOverlay') toggleWishlist();
                break;
            case 'close-search':
                if (target.id === 'searchOverlay') toggleSearch();
                break;
            case 'close-quick-view':
                if (target.id === 'quickViewOverlay' || target.classList.contains('close-quick-view')) {
                    closeQuickView();
                }
                break;
            case 'quick-view-qty': {
            ...
            case 'scroll-top':
                ...
                break;
            case 'close-lightbox':
                if (target.id === 'lightboxOverlay' || target.classList.contains('lightbox-close')) {
                    closeLightbox();
                }
                break;
            case 'lightbox-prev':
            ...
            case 'lightbox-next':
                ...
                break;
            case 'close-checkout':
                if (target.id === 'checkoutOverlay' || target.classList.contains('close-checkout')) {
                    closeCheckout();
                }
                break;
            case 'toast-close': {
